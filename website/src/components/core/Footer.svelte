<script lang="ts">
  ...
  import CMSLink from "../utility/CMSLink.svelte";
...
<footer class="footer justify-between items-center p-4 bg-base-200 text-base-content mt-5 rounded-md mb-6">
  ...
  <div class="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
    <a aria-label="To my GitHub profile (external)" href="https://github.com/Obnoxieux" target="_blank">
      <svg height="32" aria-hidden="true" viewBox="0 0 16 16" width="32" data-view-component="true"
           class="color-github-logo">
