...
<div class="prose">
    ...
    <p>David Battefeld, {contactAddress}</p>
    <p>Telefon: {contactPhone}<br/>
        E-Mail: {contactEmailAddress}</p>
    ...
    <p>Die Verarbeitung dieser Daten erfolgt auf Grundlage von Art. 6 Abs. 1 lit. b DSGVO,
        ...
        unserem berechtigten Interesse an der effektiven Bearbeitung der an uns gerichteten Anfragen (Art. 6 Abs. 1 lit.
        f
